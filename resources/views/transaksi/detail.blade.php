    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3"><font color="blue">Kasir : {{$kasir->name}}</font><br><font color="blue">Pelanggan : {{$pelanggan->nama_pelanggan}}</font></div>
                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td">{{$kembalian->kembali}}</td>
                    </tr>
                </table>
